...
public class ClassSelector {
	...
	public static void getClassOfType(Frame owner, Type t, ClassInformation ci){
		ClassLoaderDialog cld = new ClassLoaderDialog(null, ci, "/home/mabbo/GEPClassifier/GEP/bin/builtin/", t);
		cld.setVisible(true);
	}
